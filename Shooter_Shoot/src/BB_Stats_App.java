...
public class BB_Stats_App {
    ...
    private void displayGameStatus() {
    	...
    	team1.getPlayer1().displayPlayerStats();
    	System.out.println();
    	
    	team1.getPlayer2().displayPlayerStats();
    	System.out.println();
    	
    	team2.getPlayer1().displayPlayerStats();
    	System.out.println();
    	
    	team2.getPlayer2().displayPlayerStats();
    	System.out.println();
